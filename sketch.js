var player,bomb,playerImg,enemyImg;
...
function preload(){
    ...
    enemyImg = loadImage("sprite_0(1).png")
}
function setup(){
...
bomb = createSprite(15, 300, 25,75);
bomb.shapeColor = "red";
...
enemy1.setCollider("circle",0,0,20);
...
enemy6.setCollider("circle",0,0,0);
